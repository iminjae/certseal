...
export const dictionaries = {
  ko: {
    ...
    workspace: {
      ...
      subtitle: "회사 Smart Account에 귀속된 디지털 인증서를 관리합니다.",
      issueNew: "새 인증서 발급",
      viewAll: "전체보기",
      galleryTitle: "Certificate SBT 갤러리",
      gallerySubtitle: "회사 Smart Account에 발급된 인증서를 확인하세요.",
      boundNote: "Bound to company smart account",
      previous: "이전",
      next: "다음",
      viewCertificate: "인증서 보기",
      sbtBound: "SBT 귀속",
      vcSigned: "VC 서명",
      registryAnchored: "Registry 기록",
    },
    certificates: {
      title: "Certificate SBT 컬렉션",
      subtitle: "회사 Smart Account에 발급된 모든 디지털 인증서를 확인하세요.",
      issueNew: "새 인증서 발급",
      total: "전체 SBT",
      active: "유효",
      expired: "만료",
    ...
    mypage: {
      title: "마이페이지",
      subtitle: "회사 정보, 구성원, 계정 설정을 관리합니다.",
      comingSoon: "준비 중",
      description: "회사 프로필, 구성원, 인증 방식, Smart Account 설정은 이곳에서 관리될 예정입니다.",
    },
    auth: {
      common: {
        brand: "CertSeal",
      ...
      dashboard: {
        ...
        copySmartAccount: "주소 복사",
        copiedSmartAccount: "복사됨",
        issueFirst: "Issue New Certificate",
        signOut: "Sign out",
        emptyCompany: "A Company",
        ownershipNote: "Certificate SBT ownership is bound to this company smart account.",
        galleryTitle: "Certificate SBT 갤러리",
        galleryDescription: "회사 Smart Account에 발급된 디지털 인증서를 확인하세요.",
        previous: "이전",
        next: "다음",
        viewCertificate: "인증서 보기",
        sbtBound: "SBT 귀속",
  ...
  en: {
    ...
    workspace: {
      title: "Certificate Workspace",
      subtitle: "Manage digital certificates bound to your company smart account.",
      issueNew: "Issue New Certificate",
      viewAll: "View All",
      galleryTitle: "Certificate SBT Gallery",
      gallerySubtitle: "Browse certificates issued to your company smart account.",
      boundNote: "Bound to company smart account",
      previous: "Previous",
      next: "Next",
      ...
      sbtBound: "SBT Bound",
      vcSigned: "VC Signed",
      registryAnchored: "Registry Anchored",
    },
    certificates: {
      title: "Certificate SBT Collection",
      subtitle: "View all digital certificates issued to your company smart account.",
      issueNew: "Issue New Certificate",
      total: "Total SBTs",
      active: "Active",
      expired: "Expired",
    ...
    mypage: {
      title: "My Page",
      subtitle: "Manage company profile, members, and account settings.",
      comingSoon: "Coming soon",
      description:
        "Company profile, team members, authentication methods, and smart account settings will be managed here.",
    },
    auth: {
      common: {
        brand: "CertSeal",
      ...
      dashboard: {
        ...
        smartAccount: "Company Smart Account",
        issuedCertificates: "Issued Certificates",
        copySmartAccount: "Copy address",
        copiedSmartAccount: "Copied",
        issueFirst: "Issue New Certificate",
        signOut: "Sign out",
        emptyCompany: "A Company",
        ownershipNote: "Certificate SBT ownership is bound to this company smart account.",
        galleryTitle: "Certificate SBT Gallery",
        galleryDescription: "Browse certificates issued to your company smart account.",
        previous: "Previous",
        next: "Next",
        viewCertificate: "View Certificate",
        sbtBound: "SBT Bound",
